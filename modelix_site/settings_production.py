"""
Production настройки для Modelix сайта
Используйте эти настройки на VPS сервере
"""
...
SECRET_KEY = 'T+7gzZD$Kt=-lm$g19pZg_JtwFMrj^5)(QlHbUQWbxEPuslCgq'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

# Разрешенные хосты - ЗАМЕНИТЕ НА ВАШ ДОМЕН И IP
ALLOWED_HOSTS = [
    'ваш-домен.ru', 
    'www.ваш-домен.ru', 
    '83.166.247.38',  # Ваш текущий IP
    'localhost',
    '127.0.0.1'
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'modelix_db',  # ЗАМЕНИТЕ НА ВАШЕ ИМЯ БД
        'USER': 'modelix_user',  # ЗАМЕНИТЕ НА ВАШЕГО ПОЛЬЗОВАТЕЛЯ
        'PASSWORD': 'ваш_пароль_бд',  # ЗАМЕНИТЕ НА ВАШ ПАРОЛЬ
        'HOST': 'localhost',
        'PORT': '5432',
    }
}
